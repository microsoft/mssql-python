...
| Vector Datatype Support        | Native binding for the SQL Server 2025 `vector` type. Vector columns are already readable and writable today as JSON array strings, see the README | In Progress  | Q3 2026                  |
