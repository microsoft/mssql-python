...
Follows psycopg2's simple character scanning approach - does NOT parse SQL contexts.
...
def parse_pyformat_params(sql: str) -> List[str]:
    ...
    Uses simple character scanning like psycopg2 - does NOT parse SQL contexts
...
def detect_and_convert_parameters(
    sql: str,
    parameters: Union[None, Tuple, List, Dict]
    ...
    # Unsupported type
    raise TypeError(
        f"Parameters must be tuple, list, dict, or None. "
