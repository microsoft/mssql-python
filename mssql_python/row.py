...
This module provides a Row class for representing a single row of data from a database query.
"""
    ...
    def __init__(self, values: list, description: list, column_map: dict = None) -> None:
        ...
        if column_map is None:
            ...
            for i, desc in enumerate(description):
                ...
                self._column_map[col_name.lower()] = (
                    i  # Add lowercase for case-insensitivity
                )
        else:
