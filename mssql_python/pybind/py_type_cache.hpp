...
//
// Initialized when the bindings module loads. Uses raw CPython API (not pybind11) because
...
inline PyObject* get_datetime_class() { return datetime_class; }
inline PyObject* get_date_class()     { return date_class; }
inline PyObject* get_time_class()     { return time_class; }
inline PyObject* get_decimal_class()  { return decimal_class; }
inline PyObject* get_uuid_class()     { return uuid_class; }

inline py::object get_datetime_class_obj() { return borrow(datetime_class); }
inline py::object get_date_class_obj()     { return borrow(date_class); }
inline py::object get_time_class_obj()     { return borrow(time_class); }
inline py::object get_decimal_class_obj()  { return borrow(decimal_class); }
inline py::object get_uuid_class_obj()     { return borrow(uuid_class); }
