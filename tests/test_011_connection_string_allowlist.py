...
class Test_ConnectionStringAllowList:
    ...
    def test_normalize_key_encryption(self):
        ...
        assert (
            _ConnectionStringParser.normalize_key("trustservercertificate")
            == "TrustServerCertificate"
        )
        assert (
            _ConnectionStringParser.normalize_key("hostnameincertificate")
    ...
    def test_normalize_key_connection_params(self):
        ...
        assert (
            _ConnectionStringParser.normalize_key("connectretryinterval") == "ConnectRetryInterval"
        )
    ...
    def test__normalize_params_preserves_values(self):
        ...
        params = {"server": "localhost:1433", "database": "MyDatabase", "pwd": "P@ssw0rd!123"}
        filtered = _ConnectionStringParser._normalize_params(params, warn_rejected=False)
