...
class TestConnectionLogging:
    ...
    def test_connection_logs_sanitized_connection_string(self, cleanup_logger, temp_log_dir, conn_str):
...
class TestThreadSafety:
    ...
    @pytest.mark.skip(reason="Threading test causes pytest GC issues - thread ID functionality validated in unit tests")
    def test_concurrent_connections_have_different_thread_ids(self, cleanup_logger, temp_log_dir, conn_str):
